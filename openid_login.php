	...
	<div id="openid_indicator_arrow"></div>
        ...
        ?>    
               <form method="post" id="twitter_email_request" action="mods/openid/twitter/login.php">
                <input type="text" class ="twitter_email_box_empty" style="width: 350px; height: 40px; font-size: 20px;" placeholder="<?php echo _AT('openid_twitter_email_prompt'); ?>" name="twitter_email" id="twitter_email" />
