...
class OpenIDUtility
{
    ...
    /* Overload set property method for inaccesible variables.
     */ 
    function __set($name, $value)
    {
        ...
        case 'identity':
            /*
             * If an Extensible Resource Identifier(XRI) is specified as an identifier
             * for discovery, then the xri:// is trimmed off and the rest isadded as
             * identifier value. eg: xri://broadview.library.example.com/
             *                       xri://=Foo.Bar@Foo.and.Company +phone.number
             * 
             * The xri:// is optional when thay are in URI form, so that check for
             * xri of the form =Mary.Jones
             *                  @Jones.and.Company
             *                  +phone.number
            ...
            if (strlen($value = trim((String) $value))) {
                ...
                /*
                 * Now append '/' to the end of identity URI if it is not found.
                 * 
                 */
    ...
    /*
     * Overload get property method for inaccesible methods.
     */
    function __get($name)
    {
        switch ($name) {
    ...
    {
        /*
         * If curl lib is eanbled it is used for sending the requests.
         * Else the streams are used.
         */
    ...
    function discover($url)
    {
        ...
        /*
         * An XRI can be transformed into a URI by adding "http://xri.net/" at 
         * the beginning and appending the XRI. Internally, the URI now refers
         * to a proxy resolver, which resolves a URI of this kind to an XRDS 
         * document.
         */
